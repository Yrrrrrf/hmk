...
<body>
    <div class="container register-form">
        <img src="${pageContext.request.contextPath}/images/arte.jpg" alt="Sign In Icon" style="display: block; margin: 0 auto 15px auto; width: 64px; height: 64px; border-radius: 50%;">
